...
/**
 * Limitador geral - 100 requisições por 15 minutos (produção)
 * Em dev/test: 1000 requisições por 15 minutos
 */
export const generalLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutos
  max: isDev ? 1000 : 100, // requisições máximas
...
/**
 * Limitador para autenticação - 5 tentativas por 15 minutos (produção)
...
/**
 * Limitador para uploads - 30 uploads por dia (produção)
