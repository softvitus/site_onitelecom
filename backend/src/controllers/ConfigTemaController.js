/**
 * @module controllers/ConfigTemaController
 * @description Controller de gerenciamento de configurações de tema
 */
...
/**
 * Controller de Configurações de Tema
 */
  ...
  async create(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        acao: 'criar',
        entidade: 'config_tema',
        entidadeId: item.cte_id,
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao criar configuração de tema',
      });
      next(error);
    }
  }
  ...
  async update(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao atualizar configuração de tema',
      });
      next(error);
    }
  }
  ...
  async remove(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao deletar configuração de tema',
      });
      next(error);
    }
  }
...
export default ConfigTemaController;
...
export const getAll = (req, res, next) =>
  configTemaController.getAll(req, res, next);
export const getById = (req, res, next) =>
  configTemaController.getById(req, res, next);
export const create = (req, res, next) =>
  configTemaController.create(req, res, next);
export const update = (req, res, next) =>
  configTemaController.update(req, res, next);
export const remove = (req, res, next) =>
  configTemaController.remove(req, res, next);
