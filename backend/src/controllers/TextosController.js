/**
 * @module controllers/TextosController
 * @description Controller de gerenciamento de textos
 */
  ...
  async create(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao criar texto',
      });
      next(error);
    }
  }
  ...
  async update(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao atualizar texto',
      });
      next(error);
    }
  }
  ...
  async remove(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        userAgent: req.get('user-agent'),
        status: 'erro',
        mensagemErro: error.message || 'Erro ao deletar texto',
      });
      next(error);
    }
  }
...
export default TextosController;
