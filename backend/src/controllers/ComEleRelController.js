/**
 * @module controllers/ComEleRelController
 * @description Controller de gerenciamento de relações componente-elemento
 */
...
/**
 * Controller de Relações Componente-Elemento
 */
  ...
  async create(req, res, next) {
    try {
      ...
      await AuditoriaService.registrar({
        ...
        acao: 'criar',
        entidade: 'com_ele_rel',
        entidadeId: item.cer_id,
...
export default ComEleRelController;
